...
# Save the feature names and weights
...
selected_features_df.to_csv('graphs/selected_features_importances.csv', index=False)
...
# Create confusion matrix and graph it
...
file_path = 'graphs/GRAPH_conf_matrix_feat_sel.jpg'
...
plt.ylabel('Loss')
plt.xlabel('Epoch')
file_path = 'graphs/GRAPH_Loss_feat_sel.jpg'
plt.savefig(file_path, format='jpg', dpi=300)
plt.show()


# Save the model and scaler to files
joblib.dump(mlp, 'model/mlp_model_feat_sel.pkl')
joblib.dump(preprocessor, 'model/preprocessor_feat_sel.pkl')